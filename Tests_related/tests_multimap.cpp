...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/06/15 02:12:59 by charmstr          #+#    #+#             */
/*   Updated: 2021/06/15 03:14:05 by charmstr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	test_multimap_default_constructor1(void)
{
	ft::multimap<std::string, int> ft_cont;	
	assert(ft_cont.size() == 0);
}

void	test_multimap_copy_constructor(void)
{
...
void	test_multimap_operator_equal_constructor()
{
	...
	ft::multimap<std::string, int> ft_cont2;	
	assert(ft_cont2.empty() == true);
	ft_cont = ft_cont2;
	assert(ft_cont.empty());
}

void	test_multimap_range_constructor(size_t size)
{
	typedef std::pair<int, std::string> t_pair;
	ft::multimap<int, std::string> ft_cont1;	
	...
	ft::multimap<int, std::string>::iterator ft_it = ft_cont1.begin();

	//from start to end;
	ft::multimap<int, std::string> ft_cont2(ft_it, ft_cont1.end());
	...
	ft::multimap<int, std::string> ft_cont3(ft_it, ft_cont1.end());
	assert(ft_cont3.size() == ft_cont1.size() - (difference_in_size));
}

void	tests_multimap_constructors()
{
	test_multimap_default_constructor1();
	test_multimap_copy_constructor();
	test_multimap_operator_equal_constructor();
	test_multimap_range_constructor(0);
	test_multimap_range_constructor(1);
	test_multimap_range_constructor(2);
	test_multimap_range_constructor(3);
	test_multimap_range_constructor(10);
}

void	test_multimap_insert_single_element(void)
{
	typedef std::pair<int, std::string> t_pair;
	ft::multimap<int, std::string> ft_cont1;	
	ft::multimap<int, std::string>::iterator it;

	t_pair pair1(1, "salut");
	it = ft_cont1.insert(pair1);
	assert(it == ft_cont1.begin());
	assert(ft_cont1.size() == 1);

	t_pair pair2(1, "yo");
	it = ft_cont1.insert(pair2);
	assert(ft_cont1.size() == 2);
}

void	test_multimap_insert_range(void)
{
	std::multimap<int, std::string> std_cont;
	typedef std::pair<int, std::string> t_pair;
	...
	ft::multimap<int, std::string> ft_cont2;	
	std::multimap<int, std::string> std_cont2;	
...
void	tests_multimap_insert(void)
{
	test_multimap_insert_single_element();
	test_multimap_insert_range();
}

void	test_multimap_erase_range1(size_t size)
{
	ft::multimap<int, std::string> ft_cont1;	
	typedef std::pair<int, std::string> t_pair;
...
void	test_multimap_erase_range2(size_t size)
{
	ft::multimap<int, std::string> ft_cont1;	
	typedef std::pair<int, std::string> t_pair;
	...
	for (size_t i = 0; i < size; i++)
	{
		t_pair pair(i % 2, "salut");
		ft_cont1.insert(pair);
	}
	//erase all but last
	assert(ft_cont1.size() == size);
	//ft_cont1.debug(output_int_with_4_char);
	ft::multimap<int, std::string>::iterator it = ft_cont1.begin();
...
void	tests_multimap_erase(void)
{
	test_multimap_erase_range1(0);
	test_multimap_erase_range1(1);
	test_multimap_erase_range1(2);
	test_multimap_erase_range1(3);
	test_multimap_erase_range1(4);
	test_multimap_erase_range1(14);
	test_multimap_erase_range1(15);
	test_multimap_erase_range2(4); 
	test_multimap_erase_range2(5); 
	test_multimap_erase_range2(6); 
	test_multimap_erase_range2(8); 
	test_multimap_erase_range2(9); 
}
void	test_multimap_swap(void)
{	
	typedef std::pair<int, std::string> t_pair;
...
void	test_multimap_find(size_t size, int to_add)
{
	typedef std::pair<int, std::string> t_pair;
...
void tests_multimap_find(void)
{
	test_multimap_find(0, 1);
	test_multimap_find(3, 1);
	test_multimap_find(3, 4);
}

void	test_multimap_count(void)
{
	typedef std::pair<int, std::string> t_pair;
	...
	ft_cont1.insert(pair);
	assert(ft_cont1.size() == 43);
}

void	test_multimap_lower_bound(void)
{	
	ft::multimap<int, std::string> ft_cont;	
	typedef std::pair<int, std::string> t_pair;
...
void	test_multimap_upper_bound(void)
{
	ft::multimap<int, std::string> ft_cont;	
	typedef std::pair<int, std::string> t_pair;
	for (size_t i = 1; i <= 5; i++)
...
void	tests_multimap_tree_equal_range(void)
{
	typedef ft::multimap<int, std::string>::iterator it;
	ft::multimap<int, std::string> ft_cont;	
	typedef std::pair<int, std::string> t_pair;
...
{
	tests_multimap_constructors();
	tests_multimap_insert();
	tests_multimap_erase();
	test_multimap_swap();
	tests_multimap_find();
	test_multimap_count();
	test_multimap_lower_bound();
	test_multimap_upper_bound();
	tests_multimap_tree_equal_range();
}
